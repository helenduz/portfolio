            ...
            <div className='bg-light project-section-container'>
                <div className='project-section'>
                    ...
                    <p>
                        ...
                        <p>
                            Personas are archetypical but detailed profiles of your users - they have goals and tasks that represent the needs of a large group of users. Here are a few reasons why they are important:
                            <ul className='text-list'>
                                <li>Help designers share a specific, consistent understanding of the stakeholders</li>
            ...
            <div className='project-section-container'>
                <div className='project-section'>
                    ...
                    <p>
                        ...
                        <p>
                           The methods we used for data collection in this project is <span className='text-bold'>contextual inquiry</span>. This means that we observe and interview people while they are interacting with an interface!  
                        </p>
                        <p>
                        ...
                        <p>
                            An interview is a performance. Participants would always try to impress - they may act more knowledgeable, more picky, or more interesting than they really are (it's natural!). The challenge of writing good interview questions is to reduce the bias this might introduce to our data. A few important points I considered while drafting my research questions were
                        <ul className='text-list'>
                        ...
                        <p>
                        Once I had my observation notes and interview responses collected, I started outlining two personas for this interface! The personas I created are based on overarching trends I observed amongst all the users interviewed - not characteristics from a specific individual.
